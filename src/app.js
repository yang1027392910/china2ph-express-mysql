...
const h5OrderRoutes = require('./routes/h5.order.routes');
...
app.use('/api/h5/order', h5OrderRoutes);
app.use('/api/h5/coupon', require('./routes/h5.coupon.routes'));
app.use('/api/admin/coupon', require('./routes/admin.coupon.routes'));
